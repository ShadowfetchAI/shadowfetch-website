...
Obsolete note: the production site is no longer deployed through Cloudflare Pages or GitHub. `www.shadowfetch.com` now runs on a Cloudflare Worker. Keep this document only as historical context.
